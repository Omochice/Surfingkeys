...
/**
 * Register the data-driven default mappings produced by {@link createDefaultMappings} onto `api`.
 * Each mode owns a separate Trie, so the registration order across modes carries no runtime
 * meaning.
 */
 ...
 * they stay imperative rather than being modeled as {@link DefaultMappings} data.
 */
