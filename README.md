...
| settings.clickablePattern               | /(https?&#124;thunder&#124;magnet):\/\/\S+/ig | A regex to detect clickable links from text, you could use `O` to open them.                                                                                                                                                                                                                                                                                                                         |
...
| settings.historyMostUsedOrder           | true                                          | Whether to list history in order of most used beneath Omnibar.                                                                                                                                                                                                                                                                                                                                       |
