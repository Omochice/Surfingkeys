 ...
 * set it via setSanitizedContent; the groups are now rendered as separate sanitized rows and the
 * footer link is real markup. The group/row HTML is still assembled by buildUsage (it is locale-
 * and mapping-driven), so only the injection moves to Solid.
 */
