...
/**
 * The tab-chooser overlay (#sk_tabs). Renders one .sk_tab per tab with the
 * active one flagged; each non-active tab carries a .sk_tab_hint whose
 * .label/.link expandos the frontend keydown handler and refreshHints read to
 * resolve the pressed hint. Favicon attachment is injected (async,
 * extension-bound). The container's vertical/horizontal/inline class and the
 * post-render height-overflow check stay with the controller.
 */
                ...
                >
                    ...
                    <div class="sk_tab_wrap">
                        ...
                        <div
                            class="sk_tab_title"
                            style={
                                props.vertical ? undefined : { width: `${props.unitWidth - 24}px` }
                            }
                        >
                            {tab.title}
                        </div>
