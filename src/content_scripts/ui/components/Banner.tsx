 ...
 * message before injecting it, so it was always displayed as literal text; Solid's text
 * interpolation escapes it the same way. The slide-in position, visibility, and auto-hide timer
 * stay with the controller in frontend.ts.
 */
