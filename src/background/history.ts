 ...
 * These are stateless read queries against chrome.history/topSites/sessions.
 * The browser-specific history search and the shared tab/url filter are
 * injected, so the unit needs nothing from the composition root but the
