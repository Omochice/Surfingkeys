...
/**
 * Bookmark message handlers: folder listing, create/remove, and query. Owns the
 * `bookmarkFolders` cache it rebuilds from the bookmark tree, and depends only
 * on `chrome.bookmarks` and the shared deferred-response helper.
 */
