...
describe("Keystroke", () => {
    it("injects the accumulated keys and updates as the chord grows", () => {
        ...
        const { container } = render(() => <Keystroke html={html()} rich={false} />);
    ...
    it("toggles the expandRichHints class reactively", () => {
        ...
        const { container } = render(() => <Keystroke html="" rich={rich()} />);
        const root = container.querySelector("div")!;
    ...
    it("sanitizes the rich-hint HTML before injection", () => {
        ...
        const { container } = render(() => <Keystroke html={html()} rich={true} />);
